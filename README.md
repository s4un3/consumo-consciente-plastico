# Projeto Consciente Mente

## Descrição
O projeto Consciente Mente consiste (atualmente) de algumas páginas estáticas de HTML estilizadas por CSS.

Foi desenvolvido como atividade para a disciplina de Programação Web Front-End, do curso de Engenharia da Computação, na Universidade Tecnológica Federal do Paraná (UTFPR), no primeiro semestre de 2026.

Atua como um ambiente educacional e/ou informativo sobre a temática do consumo consciente de plástico e temas conectados como reciclagem. 
